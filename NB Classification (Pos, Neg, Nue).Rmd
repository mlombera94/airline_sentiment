...
#remove other common words that dont help with sentiment, wordstem and strip whitespace 
...
nuetral$text %>% wordcloud(max.words = 100, scale = c(3, .5))
